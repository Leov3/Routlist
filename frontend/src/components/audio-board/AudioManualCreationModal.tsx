                ...
                <div className="mt-4 shrink-0 rounded-[24px] border border-outline-variant bg-surface-container p-3 sm:p-4">
                  <div className="flex flex-wrap items-center justify-between gap-2">
                    ...
                    <div className="flex flex-wrap gap-2">
                      ...
                      <button type="button" onClick={() => void saveCurrentAndAdvance("create")} disabled={busy || !categories.length} className="inline-flex items-center gap-1.5 rounded-full bg-primary px-4 py-2 text-xs font-semibold text-on-primary shadow-elevation-1 sm:px-5 sm:text-sm">
