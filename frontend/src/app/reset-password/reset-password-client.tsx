    ...
    <main className="min-h-screen bg-surface px-4 py-10 text-on-surface">
      ...
      <div className="mx-auto flex min-h-[calc(100vh-5rem)] max-w-md items-center">
        <form className="surface-panel w-full rounded-[28px] p-6" onSubmit={handleSubmit}>
          ...
          <p className="mt-2 text-sm text-on-surface-variant">Define una contraseña nueva para tu cuenta.</p>

          <label className="mt-6 block text-sm font-medium text-on-surface">Nueva contraseña</label>
          <input
            value={password}
