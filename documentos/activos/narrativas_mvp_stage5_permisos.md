# Narrativas MVP - Etapa 5

Fecha: 2026-06-12

## Estado

Se reforzó la etapa 5 de Narrativas con foco en permisos y experiencia segura:

- El backend ya protege las rutas de Narrativas con `PermissionsGuard`.
...
- Se alineó la navegación global para mostrar `Narrativas` solo a quienes tienen permiso.
